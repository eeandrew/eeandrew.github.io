...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Gestures = __webpack_require__(160);
	...
	var Switch = function (_Component) {
	  ...
	  function Switch(props) {
	    ...
	    _this.onToggerTouchStart = _this.onToggerTouchStart.bind(_this);
	    _this.onToggerTouchCancel = _this.onToggerTouchCancel.bind(_this);
	    _this.setToggerTranslateX = _this.setToggerTranslateX.bind(_this);
	    _this.enableTransition = _this.enableTransition.bind(_this);
	  ...
	  _createClass(Switch, [{
	    ...
	    key: 'onXTranslateEnd',
	    value: function onXTranslateEnd() {
	      this.setState({
	        transition: null
	      });
	    }
	    ...
	    value: function setToggerTranslateX(deltaX) {
	    ...
	    key: 'onToggerTouchStart',
	    value: function onToggerTouchStart(e) {
	      if (this.props.disabled) return;
	      if (this.movingEnable) return;
	    ...
	    value: function enableTransition(isEnable) {
	      if (isEnable) {
	        this.setState({
	    ...
	    key: 'getWrapperStyle',
	    value: function getWrapperStyle(style) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('div', { className: 'switch-togger',
	...
	Switch.propTypes = {
	  ...
	  isOpen: _react.PropTypes.bool, //初始状态
	  onValueChanged: _react.PropTypes.func, //回调函数
	...
	Switch.defaultProps = {
	  ...
	  color: 'primary',
	  size: 'normal',
	  onValueChanged: function onValueChanged(isOpen) {
	    console.log(isOpen);
	  }
	};
